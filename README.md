[![Java CI with Gradle](https://github.com/ralfstuckert/spring-azurite-demo/actions/workflows/ci.yaml/badge.svg)](https://github.com/ralfstuckert/spring-azurite-demo/actions/workflows/ci.yaml)
